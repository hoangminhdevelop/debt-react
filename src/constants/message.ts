// Debt messages
export const CREATE_DEBT_SUCCESSFULLY = 'Create new debt successfully';
export const CREATE_DEBT_FAILED = 'Create new debt failed';
export const DELETE_DEBT_SUCCESSFULLY = 'Delete the debt successfully';
export const DELETE_DEBT_FAILED = 'Delete the debt failed';
